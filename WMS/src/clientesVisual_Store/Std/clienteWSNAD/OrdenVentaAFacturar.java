...
@XmlType(name = "", propOrder = { "mensError", "idEmpresa", "idDeposito", "numeroDoc", "comentario", "idCliente",
		"xmlDatos" })
@XmlRootElement(name = "OrdenVentaAFacturar")
public class OrdenVentaAFacturar {
