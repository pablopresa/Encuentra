...
public class _EncuentraCambiarEquipo extends Action 
{
	@Override
			...
			throws Exception 
	{
		...
		Logica.encuentraCambiarEquipo(equipo, numero, empresa);
		uLog.setIdEquipo(equipo);
		session.setAttribute("uLogeado", uLog);
		
		uLog.registrarEventoMin(session.getId(), "Cambia a Equipo de Trabajo "+equipo);
		
		mensaje = "Equipo de trabajo cambiado correctamente";
