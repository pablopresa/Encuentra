					...
					for (String numero : ides) 
					{
						...
						
						{
							...
							aux = aux.replaceAll(">"+numero+"<",
												 ...
												 "title='Ubicación "+numero+" lugares disponibles "+d.getCantLibre()+" Ocupados "+d.getCantOcupada()+"'>" +
												 ""+numero+"" +
												 "</div>" +
												 "</a>" +
...
//							aux += "style='background-color:red;' title='Ubicación "+numero+" lugares disponibles "+d.getCantLibre()+" Ocupados "+d.getCantOcupada()+" '>"+numero+"</td>";
							//System.out.println(aux);
						}
