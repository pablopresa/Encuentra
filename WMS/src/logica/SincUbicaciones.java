...
public class SincUbicaciones 
{
 ...
 public SincUbicaciones() {
	}
public void imprimirEtiquetas(List <Ojo> ojos) throws Exception
     {
    	 SincUbicaciones obj=new SincUbicaciones();
    	 for (Ojo ojo : ojos) 
    	 {
...
private class IntroPage implements Printable 
{
		...
		public int print(Graphics g, PageFormat pageFormat, int page) {
            try {
                ...
                Logger.getLogger(SincUbicaciones.class.getName()).log(Level.SEVERE, null, ex);
