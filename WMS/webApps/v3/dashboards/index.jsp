...
<html lang="es">
  <head>
    ...
    <jsp:include page="/v3/dashboards/menuD.jsp"></jsp:include>
   ...
   <style type="text/css">
		...
		<jsp:include page="/v3/dashboards/menu.jsp"></jsp:include>        
        <!-- /top navigation -->
    ...
    <script type="text/javascript">
      $(document).ready(function() {
		...
		$('#allOffU2').click(function() 
		 ...
		 $('#datatable-fixed-header6, #datatable-fixed-header, #datatable-fixed-header2, #datatable-fixed-header3, #datatable-fixed-header4, #datatable-fixed-header5' ).DataTable({
