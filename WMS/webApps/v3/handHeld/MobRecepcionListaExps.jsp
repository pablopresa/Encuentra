                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-body">
                        	<div>
                        	<form id="formularioDocs" method="post"action="<%=basePath%>/selExpRecep.do">
                        		<input type="text" name="listaDocs" value="1" style="visibility: hidden;">
                            	<table class="table table-compact table-bordered table-hover responsive"  width="100%" id="dataTables-example2" border=1 frame=void rules=rows cellpadding="1" >
	                                    <thead>
	                                        <tr>
	                                           	<th>Envio</th>
	                                           	<th>Unidades</th>
	                                    ...
	                                    <tbody>
	                                   	<c:forEach var="d" items="${recepcionablesE}">
												<tr class="gradeD">						
													<td style="padding: 1px; vertical-align: middle; text-align: center;">${d.idEnvio}</td>
													...
													<td style="padding: 1px; vertical-align: middle; text-align: center;">${d.choferAc}</td>
													<td style="padding: 1px; vertical-align: middle; text-align: center;"><input type="checkbox" name="${d.idEnvio}"> </td>
													<td style="padding: 1px; vertical-align: middle; text-align: center;"><a href="<%=basePath%>selExpRecep.do?nroDoc=${d.idEnvio}"><img alt="Usar" src="<%=basePath%>imagenes/icons/arrow_right.png" border="0" style="width: 20px;"></a> </td>
												</tr>
										</c:forEach>
										</tbody>
