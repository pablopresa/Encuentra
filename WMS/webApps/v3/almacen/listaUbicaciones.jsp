						...
						<div class="row">
							<div class="col-sm-6 col-lg-3">
								<div class="input-group input-group-sm mb-3">
									<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Artículo" name="art" id="art">
								</div>
							</div>
