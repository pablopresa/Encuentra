...
function setCookie(cname, cvalue, exdays) {
  //window.location.assign('http://testing.200.com.uy:8077/WMS//PPG/login.jsp');
  var d = new Date();
...
<body onload="setCookie('empresa', 'Garrido', 365);">
	                ...
	                <div class="card-body text-center border border-success rounded">
	                    ...
	                    <form action="<%=basePath%>/loginEncuentra.do" method="post">
		                    ...
		                    <input class="d-none" type="text" maxlength="2" name="pc" value="1"><br/>
		                     <input class="d-none" type="text" maxlength="2" name="idEmpresa" value="10"><br/>
