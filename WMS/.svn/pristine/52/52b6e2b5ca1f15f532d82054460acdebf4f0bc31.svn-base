		...
		<script>
		 function enviar(texto) 
		 {
		      ...
		      document.getElementById('f1').submit();
            	...
            	<div class="row">
                	<div class="col-md-12">
                    	<h3>Cargar picking&nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Desde Archivo</h3>   
                        <h6>Elija el excel con las lineas de picking. Formato de 5 columnas (Artículo, destino, cantidad, justificacion, pedido)</h6>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                <hr />
				        ...
				        <div class="col">
							<div class="card">
		                         <div class="card-header">
		                         	<h5>Ingresar desde Excel</h5>
		                        </div>
		                        <div class="card-body">
		                        	<form class="form-horizontal" role="form" enctype="MULTIPART/FORM-DATA" method="post" action="<%=basePath%>PickingManual.do">
		                            	<div class="row">		   
