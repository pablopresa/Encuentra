...
function checkCookie() 
{
  ...
  if (empresa != "") 
  {
 		window.location.assign('<%=basePath%>/'+empresa+'/login.jsp')
  } 
  else 
  {
    empresa = prompt("Por favor indique empresa:", "");
    if (empresa != "" && empresa != null) {
      setCookie("empresa", empresa, 365);
    }
  }
}
...
function setCookie(cname, cvalue, exdays) {
  ...
  window.location.assign('<%=basePath%>/'+cvalue+'/login.jsp');
}
            ...
            <div class="card rounded">
	                <div class="card-body text-center border border-success rounded">
	                    ...
	                    <form action="<%=basePath%>/loginEncuentra.do" method="post">
		                    ...
		                    <input class="d-none" type="text" maxlength="2" name="idEmpresa" value="2" ><br/>
