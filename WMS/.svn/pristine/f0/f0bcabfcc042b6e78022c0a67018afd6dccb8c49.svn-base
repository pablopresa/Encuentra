...
public class SincronizaEncuentra 
{
	...
	{	
		...
		try
		{
			...
			try
			{
				...
				List<ArticuloForus> articulosForus = MSSQL.darArticuloVs("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT [IdArticulo],[DescCorta],[talle],[color],[IdTemporada],[Coleccion],[IdProveedor],[IdMarca],[IdClase],[IdCategoria] FROM encuentra_articulos WITH (NOLOCK)",idEmpresa);
