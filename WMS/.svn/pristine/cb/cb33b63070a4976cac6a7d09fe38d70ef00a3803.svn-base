...
<%@ taglib uri="http://java.sun.com/jstl/core" prefix="c"%>
        ...
        <div id="page-wrapper" >
			<div id="page-inner">
		    	<div class="row">
                	<div class="col-md-12">
                    	<h3>Ecommerce&nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Articulos Pedidos</h3>   
                        <h6></h6>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                        	<form class="form-horizontal" role="form" id="f1" name="f1" action="<%=basePath%>/EcommerceImprimirPend.do" method="post">
                            	<table class="table table-compact table-striped table-bordered table-hover" id="encuentra-default" border=1 frame=void rules=rows cellpadding="1" >
	                                    ...
	                                    <tbody>
											<c:forEach var="a" items="${articulosReq}">
												<tr class="gradeD" style="border-collapse: collapse; border-bottom: 1px dashed black; font-size: 13px">
													...
													<td style="padding: 2px; vertical-align: middle; text-align: center;">
														<select class="form-control" id="motiv${a.articulo}">
        													<option value=""></option>
        													<option value="No encontrado">No encontrado</option>
        													<option value="En mal estado">En mal Estado</option>
        													<option value="Reservado">Reservado</option>
      													</select>
														<a class="btn btn-danger" href="javascript:deleteLinea('${a.idPedido}','${a.deposito}','${a.articulo}','${a.cantidad}','pend')">Rechazar</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
									...
									<div class="row" Style="display: flex;" >
										...
										<div style="padding-left: 520px;">
											<button type="submit"  class="btn btn-success" style="font-size: 20px;">IMPRIMIR LISTADO</button>
										</div>
									</div>
	                          </form>
						</div>
