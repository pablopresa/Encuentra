...
public class OrdenVenta 
{
	...
	private int idCliente,idMoneda,idVendedor,idPais,idMotivo,idDepEntrega,ml,idEmpresa; 
	...
	public boolean save(String urlEtiqueta, int idEmpresa)
	{
		...
		try 
		{
			...
			String query = "INSERT INTO `ecommerce_import_venta` (`idVenta`, `porcDescuento`, `Comentario`, `clidireccion`, `cliRuc`, `clicedula`, "
					...
					" VALUES ("+this.getIdCarrito()+", "+this.getPorcDescuento()+", '"+this.getCliMail()+" "+this.getComentario()+"', '"+this.getCliDireccion()+"', "
