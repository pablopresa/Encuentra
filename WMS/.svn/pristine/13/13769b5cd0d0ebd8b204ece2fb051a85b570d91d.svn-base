  ...
  <c:otherwise>
	...
	<body id="dt_example" style="border-left: 0; width: 210px;"  onload="document.forms['contactform']['cod'].focus()">
		...
		<div class="products-main" align="center" style=" width: width: 210px; float: left;">
			<p style="color: red; font-size: 12pt">Trabajando en depósito &nbsp;<c:out value="${uLogeado.deposito}"></c:out></p>
			<div id="page-wrap" style="float: left; width: width: 210px;">
				...
				<table>
						...
						<tr>
							<th style="width: 200px;">Conteo</th>
							<th style="width: 50px;">&nbsp;</th>
						</tr>
					
					
					<c:forEach var="p" items="${conteosTienda}">
						<tr>  
							<td style="width: 200px;"><div align="center">${p.descripcion}</div></td>
							<td style="width: 50px;"><div align="center"><a href="<%=basePath%>verDetalleConteoColector.do?idConteo=${p.idConteo}"><img alt="Iniciar" src="<%=basePath%>imagenes/icons/box.png" border="0" style="width: 20px;"></a></div></td>
						</tr>
					</c:forEach>
