 ...
 *         &lt;element name="Confirmar" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = { "mensError", "idEmpresa", "idDeposito", "numeroDoc", "confirmar", "comentario" })
@XmlRootElement(name = "ConfirmarOrdenVenta")
public class ConfirmarOrdenVenta {
	...
	/**
	 * Gets the value of the confirmar property.
	 * 
	 */
	...
	/**
	 * Sets the value of the confirmar property.
	 * 
	 */
	public void setConfirmar(boolean value) {
