...
<c:if test="${uLogeado!=null}">
			<div class="products-main" align="center" style=" width: width: 210px; float: left;">
				...
				<form id="contactform" class="rounded"  action="<%=basePath%>TraerDocsVerif.do" style="float: left; width: 210px;">
					...
					<div class="field" align="center" >
						<label for="Dori">Deposito de origen:</label>
						<select name="Dori" id="Dori">
