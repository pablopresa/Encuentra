...
<script type="text/javascript">
	...
	function subm(event,type) 
	{
		...
		if(type==0)
		{
			if(confirm("Desea confirmar las cantidades de la recepción ("+count+")?"))
			{
	...
	function subm3() 
	{
		if(confirm("Desea Reiniciar las cantidades de la recepción ("+count+")?"))
		{
			codigos = [];
			count = 0;
			simbolo = ' + '
			...
			<div class="field" align="center">
				...
				<div class="field" align="center">
					<input type="button" class="button" onclick="subm3()"
						value="Reiniciar Recepción" style="width: 191px; "/>
