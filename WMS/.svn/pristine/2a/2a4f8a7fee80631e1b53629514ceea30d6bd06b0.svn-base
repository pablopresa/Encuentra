...
<c:if test="${uLogeado!=null}">
			<div class="products-main" align="center" style=" width: width: 210px; float: left;">
				...
				<form onsubmit="trimArt()" id="contactform" class="rounded" method="post" action="<%=basePath%>DarOjosArti.do" style="float: left; width: 210px;">
					...
					<div class="field" align="center" >
						<label>Articulo/Ubicacion:</label>
						<input type="text" class="input" name="art" id="codArt" style="width: 191px; " required/><br/>
...
<script type="text/javascript">
	function trimArt(){
		var art = document.getElementById('codArt').value.trim();
		document.getElementById('codArt').value = art;
