...
public class Clientes 
{
	...
	public void save(int idEmpresa, Long idPedido)
	{
		String query = "INSERT INTO `ecommerce_import_clientes` (`Nombre`, `Apellido`, `Direccion`, `Ciudad`, `Departamento`, `cpostal`, `telefono`, `mail`, `cedula`,idEmpresa,idPedido) "+ 
					"VALUES ('"+this.getNombre()+"', '"+this.getApellido()+"', '"+this.getDireccion()+"', '"+this.getCiudad()+"', '"+this.getDepartamento()+"', '"+this.getCodigoPostal()+"', '"+this.getTelefono()+"', '"+this.getMail()+"', '"+this.getNumero()+"',"+idEmpresa+","+idPedido+");";
