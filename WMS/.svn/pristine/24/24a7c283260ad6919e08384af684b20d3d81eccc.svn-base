        ...
        <!-- /. NAV SIDE  -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                    		<h5>
                            	 Imprimir etiquetas de códigos de barra
                             </h5>
                        </div>
                        <div class="card-body">
							
							<form action="<%=basePath%>PrintArticulosBarrasRecepcionII.do" method="post" id="f1" name="f1">
								<div class="table-responsive">
	                            	<table class="display table nowrap table-striped table-hover dataTable" id="encuentra-default">
	                                    ...
	                                    <tbody>
											<c:forEach var="ar" items="${listaBarrasRecepcion}">
												<tr class="gradeD">
													<td class="text-center">Art. ${ar.descripcion}</td>
										            <td class="text-center"><c:out value="${ar.descripcionB}"></c:out></td>
										            <td class="text-center"><c:out value="${ar.descripcionC}"></c:out></td>
										            <td class="text-center"><input name="${ar.descripcion}Qty"  class="form-control" type="number" value="${ar.id}" style="width: 100px"></td>
													<td class="text-center">
														<div class="checkbox checkbox-fill d-inline">
															<input type="checkbox" name="${ar.descripcion}" id="checkbox-fill-${ar.descripcion}" checked="checked" >
															<label for="checkbox-fill-${ar.descripcion}" class="cr"></label>
														</div>
													</td>
												</tr>
											</c:forEach>
	                                ...
	                                <div class="row">
	                                	<div class="text-right col-sm-12 col-lg-12"> 
	                                 		<div class="flex-container">
												...
												<button class="btn btn-info">Imprimir Etiquetas</button>
											</div>
										</div> 
	                                </div>
	                               </form>
