         ...
         <div class="row" >
            <div class="col-md-12">
                <div class="card">
                	...
                	<div class="card-body">
                		<form class="form-horizontal" id="buscarPeds" role="form" action="<%=basePath%>/ReporteTest.do">
							<div class="row">
											...
											<div class="col-md-10">
												<div class="input-group input-group-sm">
													<input type="number" class="form-control bg-white" aria-label="Small"
														aria-describedby="inputGroup-sizing-sm" name="desde">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group input-group-sm">
													<input type="number" class="form-control bg-white" aria-label="Small"
														aria-describedby="inputGroup-sizing-sm" name="hasta">
												</div>
											</div>
										</div>
									</div>
							     ...
							     <table class="display table nowrap table-striped table-hover dataTable" id="encuentra-default">
							        ...
							        <tbody>
							            ...
							            <tr>
											...
											<td class="text-center">${l.valor}</td>
