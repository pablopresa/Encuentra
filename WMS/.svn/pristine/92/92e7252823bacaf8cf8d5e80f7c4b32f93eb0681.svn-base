        ...
        <!-- /. NAV SIDE  -->
            	<div class="row">
                    	...
                    	<div class="text-right col-sm-6 col-lg-6"> 
							<div class="flex-container">	
                       			 <a href="<%=basePath%>consolaPedidosEcommerce.do" class="btn btn-info"><span class="fas fa-arrow-left"></span>&nbsp;Atrás</a>
                    		</div>
                    	</div>
                </div>              
                 <!-- /. ROW  -->
                    ...
                    <div class="accordion" id="accordionExample">
						<div class="card">
					        <div class="card-header" id="headingOne">
					            <h5 class="mb-0"><a href="#!" class="collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Formulario de edición de pedido</a></h5>
					        </div>
...
<!-- 												  			</select> -->
					    ...
					    <div class="card">
					        <div class="card-header" id="headingTwo">
					            <h5 class="mb-0"><a href="#!" class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Formulario de edición de datos del cliente</a></h5>
					        </div>
		                            ...
		                            <form class="form-horizontal" role="form" method="post" action="<%=basePath%>/editarPedidoEcommerceIII.do">
		                            	<div class="row">
											...
											<div class="col-sm-3 col-lg-2">
												<div class="form-group">
													<label class="col-md-12 control-label" for="art">Nº Puerta:&nbsp;</label>
	       											<div class="col-md-12">
											...
											<div class="col-sm-3 col-lg-2">
												<div class="form-group">
													<label class="col-md-12 control-label" for="art">Nº Apto.:&nbsp;</label>
	       											<div class="col-md-12">
											...
											<div class="col-sm-6 col-lg-4">
												<div class="form-group">
													<label class="col-md-12 control-label" for="art">Código Postal:&nbsp;</label>
	       											<div class="col-md-12">
											...
											<div class="col-sm-6 col-lg-4">
												<div class="form-group">
													<label class="col-md-12 control-label" for="art">Teléfono:&nbsp;</label>
	       											<div class="col-md-12">
	        ...
	        function deleteArt(ped,arti,depo,canti)
				{
					...
					if (confirm('Seguro que desea eliminar este articulo?, esta acción no tiene forma de deshacerse'))
					{
				...
				function confirmarArt(ped,arti,depo)
				{
					...
					if (confirm('Seguro que desea confirmar este articulo?, esta acción no tiene forma de deshacerse'))
					{
