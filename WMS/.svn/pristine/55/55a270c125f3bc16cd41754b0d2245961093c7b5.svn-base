		...
		<script type="text/javascript"> 
		 function handleEnter (field, event) 
			...
			<script>
            	...
            	<div class="row">
                	<div class="col-md-12">
                    	<h3>Recepción de Mercaderías&nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;ver órdenes de compra</h3>   
                        <h6>Elija el proveedor y se cargarán las órdenes de compra abiertas. </h6>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                <hr />
