...
{
	private String articulo, articuloBaseColor, articuloBase, depoCliente, nombreRegla, descripcionLinea;
	private int marca,clase,venta,stockCentral,stockLocal, stockBaseColor,precio, sucursal, origen, 
	destino, idpicking, idLineaSAP, genero, categoria, minCentral, maxLocal,temporada,solicitud,tipo, prioridad;
	private List <DepositoDimension> depositos;
	private List <DepositoDimension> depositosInvertidos;
	...
	public ArticuloReposicion(String articulo, String articuloBaseColor, String articuloBase, int marca, Long seccion, int clase, int venta,	
			int stockCentral, int stockLocal, int stockBaseColor, int precio, int sucursal, int genero, int categoria, int temporada, int tipo) 
	{
		this.articulo = articulo;
		this.articuloBaseColor = articuloBaseColor;
		this.articuloBase = articuloBase;
	...
	public List<DepositoDimension> getDepositos() {
		return depositos;
	}
	public void setDepositos(List<DepositoDimension> depositos) {
		this.depositos = depositos;
	}
	public List<DepositoDimension> getDepositosInvertidos() {
		return depositosInvertidos;
	}
	public void setDepositosInvertidos(List<DepositoDimension> depositosInvertidos) {
		this.depositosInvertidos = depositosInvertidos;
	}
