 ...
 *       &lt;sequence>
 *         &lt;element name="ConsTipoCambioResult" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = { "consTipoCambioResult", "mensError", "tipoCambio", "arbitraje" })
@XmlRootElement(name = "ConsTipoCambioResponse")
public class ConsTipoCambioResponse {

	@XmlElement(name = "ConsTipoCambioResult")
	protected boolean consTipoCambioResult;
	...
	/**
	 * Gets the value of the consTipoCambioResult property.
	 * 
	 */
	public boolean isConsTipoCambioResult() {
		return consTipoCambioResult;
	}

	/**
	 * Sets the value of the consTipoCambioResult property.
	 * 
	 */
	public void setConsTipoCambioResult(boolean value) {
		this.consTipoCambioResult = value;
	}
