...
<body onload=" document.getElementById('test').focus();">
	<c:if test="${uLogeado!=null}">
	<form id="contactform" class="rounded" method="post"  action="<%=basePath%>/updateUConteo.do" style="float: left;">
		...
		<div class="row">
			...
			<input type="text" name="artValido" id="artValido" style="display: none;">
				<table>
					...
					<tr>
						<td><input type="text" class="inputCH" name="idOjo" id="base" onkeypress="nextel(event.keyCode)" value="000"/></td>					
						<td><input type="checkbox" checked="checked"  readonly="readonly" name="valida" id="valida"></td> 
					</tr>
				</table>
				<table>
					<tr>
					...
					<tr>
						<td style="width: 100%"><input type="text" name="test" id="test"  onkeypress="onTestChange(event);"/></td>
