                        ...
                        <label>WMS</label>
							...
							<li class="nav-item pcoded-hasmenu">
		                        ...
		                        <a 
		                        	...
		                        	<span class="pcoded-mtext">Depositos</span>
		                        </a>
                ...
                <li class="nav-item">
                    <div class="main-search">
                        <div class="input-group">
                            <input type="text" id="m-search" class="form-control" placeholder="Buscar en menú . . .">
                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                ...
                                <li><a class="dropdown-item md-trigger" data-modal="modal-Depo"><i class="feather icon-home"></i>Depósito <span class="badge badge-pill badge-secondary" id="li_depo">${uLogeado.deposito}</span></a></li>
                                <li><a class="dropdown-item md-trigger" data-modal="modal-Pass"><i class="feather icon-user"></i>Cambiar Contraseña</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
