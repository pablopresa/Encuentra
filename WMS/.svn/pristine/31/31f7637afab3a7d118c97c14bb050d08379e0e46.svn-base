  ...
  <c:otherwise>
	...
	<body id="dt_example" style="border-left: 0; width: 210px;"  onload="document.forms['contactform']['cod'].focus()">
		...
		<div class="products-main" align="center" style=" width: width: 210px; float: left;">
			<form class="form-horizontal" role="form" method="post"  action="<%=basePath%>cambioEquipo.do?mob=1">
				<p style="color: red; font-size: 12pt">Trabajando en Equipo &nbsp;<c:out value="${uLogeado.idEquipo}"></c:out></p>
			...
			<p> </p>
				<input class="col-100 button" type="submit" name="1" value="Cambiar Equipo"/>
