...
public class ActRecorrid {
    ...
    private static final String iTextExampleImage = "C:/Program Files/apache-tomcat-7.0.64/webapps/WMS/pdf/FORUS.png";
    /**
	...
	{
		ActRecorrid generatePDFFileIText = new ActRecorrid();
	    generatePDFFileIText.createPDF(new File("C:/Program Files/apache-tomcat-7.0.64/webapps/WMS/pdf/etiq.pdf"));
