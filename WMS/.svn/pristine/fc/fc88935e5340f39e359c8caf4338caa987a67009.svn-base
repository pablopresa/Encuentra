		...
		<c:forEach var="d" items="${uLogeado.seguridadUI}">
			...
			<div class="products-main" align="center" style=" float: left;">
				...
				<table >
							...
							<tr class="gradeD">
								<td class="text-center">
									...
									<c:if test="${d.cant>0}"> 
										...
										<td class="text-center">
										<!-- <a href="<%=basePath%>/pickupRechazarPedido.do?idPedido=${idPedido}" onclick="return confirm('¿No lo encontró? se cancelara el pedido');"><img alt="Iniciar" src="<%=basePath%>imagenes/icons/cancel.png" border="0" style="width: 20px;"></a> -->
										</td>
									</c:if>
					...
					<div class="col-100">
						<a href="<%=basePath%>/MenuMob.do?sec=M.C"><input class="col-100 button" type="button" name="2"  value="Ir a Menú"/></a>
					</div>
