...
<body onload=" document.getElementById('base').focus();">
	<c:if test="${uLogeado!=null}">
	<form id="contactform" class="rounded" method="post"  action="<%=basePath%>/AgregaraUbicacion.do" style="float: left;">
		<div class="row">
		...
		<div class="row">
			<div class="col-100">
				...
				<input type="button" class="col-100 button" onclick="subm(event,1)" value="Agregar" />												
