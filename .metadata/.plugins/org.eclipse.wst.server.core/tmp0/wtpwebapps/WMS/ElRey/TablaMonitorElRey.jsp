                           		...
                           		<table class="table table-compact table-bordered table-hover" id="tablaEnc-monitor-ElRey">
									...
									<c:forEach var="p" items="${lstPedidosConsola}">
										...
										<tr class="gradeD" style=<c:out value="${color}"></c:out>>	
											...
											<a href="${urlMonitorEC}${p.idPedido}/detalle" target="_blank">${p.idMS}</a></td>	
						                        ...
						                        <div class="btn-group mb-2 mr-2">
										            ...
										            <div class="dropdown-menu">
														...
														<a class="dropdown-item" href="#" onclick="editPedido(${p.idPedido})"><i class="fas fa-edit"></i>Editar</a>
								                   		...
								                   		<a class="dropdown-item" <c:if test="${p.urlFactura!=''}">href="${p.urlFactura}"</c:if> target="_blank"><i class="fas fa-file-invoice-dollar"></i>Factura</a>
										            </div>
										        </div>												
											</td>
