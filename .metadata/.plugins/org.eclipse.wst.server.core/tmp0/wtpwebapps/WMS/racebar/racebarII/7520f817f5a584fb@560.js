  ...
  main.variable(observer("chart")).define("chart", ["d3","DOM","width","height","top_n","brandData","halo","tickDuration"], function(d3,DOM,width,height,top_n,brandData,halo,tickDuration)
{
  ...
  let ticker = d3.interval(e => {
    ...
    if(year == 10) ticker.stop();
    year = d3.format('.1f')((+year)+1 );
    if (datumpje.getFullYear()+'-'+(datumpje.getMonth()+1) =='2012-12') datumpje.setMonth(datumpje.getMonth() +6);
...
d3.csv('https://gist.githubusercontent.com/sannehombroek/19eb7c93d2e6de64ab02976145c8eacc/raw/2759b78c70243c91c962f08bf3546a063f2b7763/racerankcode.csv')
)});
