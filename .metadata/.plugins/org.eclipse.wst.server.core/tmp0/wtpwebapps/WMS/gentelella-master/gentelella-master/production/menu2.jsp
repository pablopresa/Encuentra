...
<!DOCTYPE html>
<html data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-83" data-genuitec-path="/encuentra/webApps/gentelella-master/gentelella-master/production/menu2.jsp">
  
            <!-- sidebar menu -->
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>General</h3>
                <form action="<%=basePath%>DarDashTag.do" id="filtros">
                  ...
                  <li><a><i class="fa fa-star"></i> Marcas <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-pie-chart"></i> Clases <span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu" id="clasesList">
                    	...
                    	<li id="visibleC2"> <table><tr><td><div id="allInC2" class="btn btn-primary">All ON</div></td><td><div id="allOffC2" class="btn btn-primary">All OFF</div></td><td><input type="submit" value="Filtrar" class="btn btn-success"></td></tr></table></li>
                    ...
                    <ul class="nav child_menu" id="generosList">
                    	<li> <table><tr><td><div id="allInG" class="btn btn-primary">All ON</div></td><td><div id="allOffG" class="btn btn-primary">All OFF</div></td><td><input type="submit" value="Filtrar" class="btn btn-success"></td></tr></table></li>
