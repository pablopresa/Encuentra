...
<%@ taglib uri = "http://java.sun.com/jsp/jstl/functions" prefix = "fn" %>
    ...
    <div class="md-modal md-effect-1" id="modal-Equipo">
			        <div class="md-content">
			            <h3 class="theme-bg2">Cambiar equipo de impresión</h3>
			            <div class="row">
				            <div class="col-md-2"></div>
				            <div class="col-md-8">
				            
								<div class="form-group">
									<label class="col-md-6 control-label" for="p1">Nº Equipo Actual:</label>
									<div class="col-md-12">
			    ...
			    <div class="md-modal md-effect-1" id="modal-Depo">
			        <div class="md-content">
			            <h3 class="theme-bg2">Cambiar Depósito</h3>
			            <div class="row">
				            <div class="col-md-2"></div>
				            <div class="col-md-8">
				              
								<div class="form-group">
									<label class="col-md-6 control-label" for="p1">Nº Depósito Actual:</label>
									<div class="col-md-12">
			    ...
			    <div class="md-modal md-effect-1" id="modal-Pass">
			        <div class="md-content">
			             <h3 class="theme-bg2">Cambiar Contraseña</h3>
