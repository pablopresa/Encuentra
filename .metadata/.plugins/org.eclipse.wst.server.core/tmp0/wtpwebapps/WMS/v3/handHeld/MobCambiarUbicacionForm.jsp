...
<script type="text/javascript">
	...
	function subm(event) 
	{
		var ojoOrigen = document.getElementById("base").value;
		var ojoDestino = document.getElementById("baseD").value;
		var destino = document.getElementById("destino").value;
		if (ojoOrigen != "" && ojoDestino != ""){
			if(destino == ""){
				if(confirm("ATENCIÓN! Se moverán todos los artículos del ojo "+ojoOrigen+" al ojo "+ojoDestino+", desea continuar?")){
					subm2();
				}
			} else {
	...
	<form id="contactform" class="rounded" method="post"  action="<%=basePath%>/moverUbicacion.do" style="float: left;">
		...
		<div class="row">
			<div class="col-100">
				...
				<input type="button" class="col-100 button" onclick="subm(event,1)" value="Mover" />												
