					...
					<tr>
						...
						<c:forEach var="d" items="${detallePedido}">
							<tr class="gradeD">
								...
								<td>
									<a href="<%=basePath%>/pickupRechazarPedido.do?idPedido=${idPedido}&idArticulo=${d.idArticulo}" onclick="return confirm('¿No lo encontró? se cancelara el pedido');"><img alt="Iniciar" src="<%=basePath%>imagenes/icons/cancel.png" border="0" style="width: 20px;"></a>
								</td>
							</tr>
						</c:forEach>
