	...
	<body id="dt_example" style="border-left: 0; width: 210px;">
		...
		<div class="products-main" align="center" style=" width: width: 210px; float: left;">
			<div id="page-wrap" style="float: left; width: width: 210px;">
				...
				<p><b> buscando artículo: ${art} <br/> ${descripcionArticulo}<br/> </b></p>
				...
				<table id="customers">
					...
					<tr class="gradeD">
						...
						<td><input class="button" type="button" name="0"  onclick="Usar('${ot.idOjo}');"   value="Usar"/></td>
					</tr>
					</c:forEach>
				</table>
		...
		<script type="text/javascript">
			...
			function Usar(idOjo)
			{
				var destino = '<%=basePath%>cambiarOjo.do?idOjo='
				window.location=destino+idOjo;
			}
