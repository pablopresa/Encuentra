...
<body onload=" document.getElementById('base').focus();">
	<c:if test="${uLogeado!=null}">
	<form id="contactform" class="rounded" method="post"  action="<%=basePath%>/countUbicacion.do" style="float: left;">
		...
		<div class="row">
			...
			<input type="text" name="artValido" id="artValido" style="display: none;">
				...
				<table>
					...
					<tr>
						<td style="width: 33%"><input style="border: 0px;  width: 100%; height: 2em;" type="radio" id="Act" name="opperation" value="act" checked></td>
						<td style="width: 33%"><input style="border: 0px;  width: 100%; height: 2em;" type="radio" id="Add" name="opperation" value="add"></td>
				...
				<table>
					...
					<tr>
						...
						<td style="width: 15%"><input style="padding: 1px;" type="number" min="1"  name="canti" id="canti"  value=1 /></td>
