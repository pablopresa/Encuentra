...
<%@ taglib uri="http://java.sun.com/jstl/core" prefix="c"%>
		...
		<script type="text/javascript"> 
			...
			<script>
            	...
            	<div class="row">
                	<div class="col-md-12">
                    	<h3>Expedición&nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Alta Envío&nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Seleccionar depósito</h3>   
                            	...
                            	<div class="row">
                            		<div class="col-sm-6 col-lg-4">
								        <div class="form-group">								          
								          <label class="col-md-4 control-label" for="art" class="col-md-6 control-label">Deposito:&nbsp</label>
								          <div class="col-md-8">
							...
							<div class="table-responsive">
								...
								<div class="row">
								    ...
								    <div class="col-sm-6 col-lg-3">
								        <div class="form-group">								          
								          <div class="col-md-8" style="text-align: center;">
								          		<a class="btn btn-info" href="javascript:enviar('Cargar otro');">Cargar otro</a>								            	
								          </div>
								        </div>
								    </div>
								    <div class="col-sm-6 col-lg-3">
								        <div class="form-group">
								          <div class="col-md-8" style="text-align: center;">
								            	<a class="btn btn-info" href="javascript:enviar('Guardar Parcial');">Guardar Parcial</a>
								          </div>
								        </div>
								    </div>
								    <div class="col-sm-6 col-lg-3">
