...
<jsp:include page="/v3/util/menu.jsp"></jsp:include>
            	...
            	<div class="row">
                	<div class="col-md-12">
                        ...
                        <h6>Version de impresion</h6> <!--  <h5><a href="<%=basePath%>v3/altaEnvioIIIVPAll.jsp">Ver detalle</a></h5>-->
                    </div>
                </div>              
                 <!-- /. ROW  -->
                <hr />
                    ...
                    <c:forEach var="depo" items="${envio.depositos}">
	                    ...
	                    <div class="card" id="printP">
	                        <div class="card-header">
	                        	<h5>
	                             	Detalle de unidades del remito de entrega ${envio.idEnvio} a Suc ${depo.idDeposito} del ${envio.fechaVis}
	                            </h5>
	                        </div>
	                        <div class="card-body">
                            	...
                            	<div class="row">
                            		<div class="col-sm-6 col-lg-4">
	                            		<div class="form-group">
									          ...
									          <div class="col-md-8">
									            	<input required class="form-control" name="idEsta" id="idEsta" readonly="readonly" value="FORUS" />
									          </div>
									    </div>
								    </div>
