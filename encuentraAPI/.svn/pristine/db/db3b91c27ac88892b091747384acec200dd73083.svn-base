 ...
 *         &lt;element name="almacenOrigen" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "psIdSesion", "codCliente", "nroSolTraslado", "listaArticulos", "serie",
		"almacenDestino", "comentario", "prioridad", "motivo", "almacenOrigen" })
@XmlRootElement(name = "CrearTraslado")
public class CrearTraslado {
	...
	protected String almacenOrigen;
	...
	/**
	 * Gets the value of the almacenOrigen property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	...
	/**
	 * Sets the value of the almacenOrigen property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
