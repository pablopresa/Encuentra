...
@XmlType(name = "", propOrder = { "mensaje", "nroUsuario", "idEquipo", "idTienda", "nroEmpresa", "idDeposito", "fecha",
		"hora", "comentario", "tipoAjuste", "idRazonDocumento", "xmlDetalle" })
@XmlRootElement(name = "GrabarAjusteStock")
public class GrabarAjusteStock {
