 ...
 *       &lt;sequence>
 *         &lt;element name="SaldoPuntoxCodWebResult" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = { "saldoPuntoxCodWebResult", "mensError", "saldoPuntos" })
@XmlRootElement(name = "SaldoPuntoxCodWebResponse")
public class SaldoPuntoxCodWebResponse {

	@XmlElement(name = "SaldoPuntoxCodWebResult")
	protected boolean saldoPuntoxCodWebResult;
	...
	/**
	 * Gets the value of the saldoPuntoxCodWebResult property.
	 * 
	 */
	public boolean isSaldoPuntoxCodWebResult() {
		return saldoPuntoxCodWebResult;
	}

	/**
	 * Sets the value of the saldoPuntoxCodWebResult property.
	 * 
	 */
	public void setSaldoPuntoxCodWebResult(boolean value) {
		this.saldoPuntoxCodWebResult = value;
	}
