...
public class Compra
{
    ...
    {
        return "ClassPojo [importe = "+importe+", id = "+id+", estado = "+estado+", fecha = "+fecha+", items = "+items+", moneda = "+moneda+"]";
    }
	...
	public String getArtEnvio() {
		return artEnvio;
	}

	public void setArtEnvio(String artEnvio) {
		this.artEnvio = artEnvio;
	}
