...
{
	int cantidadPendiente,totalPedido, totalProcesado, idDeposito, ml, canal, idImpresora, estadoEncuentra,idDestino;
	String idArticulo, descripcion,urlEtiqueta, mensaje, ciCliente, telCliente, mailCliente, fecha,idEcommerce, 
	subpedido,ticketNumber, fechaEntrega, tracking;//idFenicio
	Long idPedido;
