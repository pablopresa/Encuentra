...
public class OrdenVenta 
{
	...
	private String cliCedula,cliNombre,cliDireccion,cliRuc,cliTelefono,comentario, formaPago,cliMail,fecha,formaPagoVisual;
	...
	public boolean save(String urlEtiqueta)
	{
		...
		for (OrdenVentaLinea ovl : this.getOrdenVentaLineas()) 
		{
			...
			insertsVtaLineas.add("INSERT INTO `ecommerce_import_ventalinea` (`idVenta`, `idArticulo`, `cantidad`, `precioImp`) VALUES ("+this.getIdCarrito()+", '"+ovl.getIdArticulo()+"', '"+ovl.getCantidad()+"', '"+ovl.getPrecioImp()+"');");
		}
		...
		try 
		{
			...
			String query = "INSERT INTO `ecommerce_import_venta` (`idVenta`, `porcDescuento`, `Comentario`, `clidireccion`, `cliRuc`, `clicedula`, `clinombre`, `clitelefono`, `uletiqueta`, `totalunidades`, `Sincronizada`, `ML`, `FP` ,`importePago`, `mail`,`FPVisual`) " +
					" VALUES ("+this.getIdCarrito()+", "+this.getPorcDescuento()+", '"+this.getComentario()+"', '"+this.getCliDireccion()+"', '"+this.getCliRuc()+"', '"+this.getCliCedula()+"', '"+this.getCliNombre()+"', '"+this.getCliTelefono()+"', '"+urlEtiqueta+"', "+cantUnidades+", 0, "+this.getMl()+",'"+this.getFormaPago()+"',"+this.getImportePago()+",'"+this.getCliMail()+"','"+this.getFormaPagoVisual()+"')";
			...
			if(this.getFormaPagoVisual()!=null && !this.getFormaPagoVisual().equals(""))
			{
				hayUpdate=true;
				onDup += ", fpVisual = '"+this.getFormaPagoVisual()+"' ";
			}
	...
	public String getFormaPagoVisual() {
		return formaPagoVisual;
	}

	public void setFormaPagoVisual(String formaPagoVisual) {
		this.formaPagoVisual = formaPagoVisual;
	}
