...
public class CallBackPedido {
	...
	public boolean save(){
		try {
		String query ="INSERT INTO `callbackpedidoencuentra`"
				+ " (`idPedido`, `idEstado`, `mensaje`, `idEmpresa`, `printer`) "
				+ " VALUES ('"+this.idPedido+"', '"+this.idEstado+"', '"+this.mensaje+"', '"+this.idEmpresa+"',"+this.printer+");";
	...
	public boolean update(String mensaje, int idEstado){
		try {
		String query ="UPDATE callbackpedidoencuentra \r\n" + 
				"SET idEstado = "+idEstado+", \r\n" + 
				"mensaje = "+mensaje+" \r\n" + 
				"WHERE idLlamada = "+this.idLlamada+";";
		 LogicaAPI.persistir(query);
		 return true;
		}
		catch (Exception e) {
