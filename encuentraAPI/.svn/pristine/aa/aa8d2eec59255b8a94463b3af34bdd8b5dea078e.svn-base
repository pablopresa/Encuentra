...
@XmlType(name = "", propOrder = { "xmlDatos", "mensaje", "xmlArtSinStk", "xmlDocGrabados" })
@XmlRootElement(name = "GrabarOrdenVentaSelvirXml")
public class GrabarOrdenVentaSelvirXml {
