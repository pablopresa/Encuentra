 ...
 *         &lt;element name="IdDepDestino" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlType(name = "", propOrder = { "mensaje", "idUsuario", "idEquipo", "idTienda", "nroEmpresa", "idDeposito", "fecha",
		"hora", "comentario", "idDepDestino", "idRazonDocumento", "xmlDetalle", "confirmada" })
@XmlRootElement(name = "GrabarTransferenciaTienda")
public class GrabarTransferenciaTienda {
	 ...
	 * 
	 */
	public void setIdDepDestino(int value) {
