...
@XmlType(name = "", propOrder = { "perrorreturn", "perrormessage" })
@XmlRootElement(name = "WSIntegracionConfirmarFirmaComprobante_0205.ExecuteResponse")
public class WSIntegracionConfirmarFirmaComprobante0205ExecuteResponse {
