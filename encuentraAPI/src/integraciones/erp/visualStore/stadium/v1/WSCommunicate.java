...
public class WSCommunicate {
	...
	public int encolarTransferenciaTienda(int origen, int destino,List<DataIDDescripcion>lista, String coments,short idTienda, short equipo, 
			short tienda,Long usuario,boolean confirmada, String coment, int razon, String idPedido, int doc, String descripcion)
	{		
		try 
	    {			
			...
			int id=eper.persistirDarUltimo(q1,"cola_mov_stock","id");
	...
	*/
	public DataIDDescripcion GrabarTransferencia(int origen, int destino,List<DataIDDescripcion>lista, String coments,short idTienda, short equipo, short tienda,Long usuario,boolean confirmada, String coment, int razon)
	{
		SWStadium service = new SWStadium();
		Long empresa = (long) 50000;
		SWStadiumSoap port = service.getSWStadiumSoap();
